            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionContent(
                    '''Thank you for choosing Shop Nest, an e-commerce platform where you can buy and sell products with ease. By using our app, you agree to the following terms and conditions. Please read them carefully before proceeding.''',
                    screenSize, textScaleFactor),
                SizedBox(height: screenSize.height * 0.03),
                _buildSectionTitle('2. User Agreement', screenSize, textScaleFactor),
                _buildSectionContent(
                    '''When using Shop Nest, you agree to adhere to all applicable laws and regulations. You must provide accurate and truthful information during registration and agree to maintain the confidentiality of your account credentials.''',
                    screenSize, textScaleFactor),
                SizedBox(height: screenSize.height * 0.03),
